...
public class CitaController {
    ...
    /**
     * Busca citas por fecha o motivo
     * @param criterio Texto a buscar (puede ser fecha o motivo)
    ...
    private boolean validarDatosCita(Cita cita) {
        ...
        if (cita.getFechaHora() == null || cita.getFechaHora().trim().isEmpty()) {
            System.err.println("❌ La fecha y hora de la cita no puede estar vacía.");
            return false;
        }
        ...
        if (cita.getMascota_id() <= 0) {
            System.err.println("❌ El ID de la mascota debe ser un número positivo.");
            return false;
        }
        if (cita.getVeterinario_id() <= 0) {
            System.err.println("❌ El ID del veterinario debe ser un número positivo.");
            return false;
        }
        return true;
    }
